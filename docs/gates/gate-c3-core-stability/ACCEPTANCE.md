...
**ACCEPTED / PASS / AWAITING NORMAL PUBLICATION / NOT DEPLOYED.**
Код принят на `b1ed94c6ddfefe957a50f4d133537f74482910cc`, tree `9acb41b5bf6d2a91b8964f84f4c459d072d0c127`. Обычный PR публикуется после отдельной проверки последнего изменения только документации. Весь MVP1 ещё не READY; C4 не запущен.
