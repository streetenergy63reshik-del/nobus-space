    ...
    def _build_prompt(
        ...
        payload: dict[str, object] = {
            ...
            "response_protocol": (
                ...
                "This is an internal product worker turn, not a primary/root Codex "
                "Desktop task. Do not send notifications or append any nobus-notify "
                "marker, HTML comment, or notification summary. "
