# Gate C3 — исходный контракт работы

Историческая постановка и reuse/gap на входе C3. Итоговый результат — [ACCEPTANCE](ACCEPTANCE.md), точные проверки — [EVIDENCE](EVIDENCE.json).
