...
локального checkpoint. Обе разрешённые small пробы завершены с hard FAIL.
Предложена одна независимая Chirp3 гипотеза; её подготовка требует выбора
существующего Google Cloud project, а trial — точного отдельного разрешения
на синтетическое audio/cost после preflight. При квалификации следуют B02 и приёмка окончательного
