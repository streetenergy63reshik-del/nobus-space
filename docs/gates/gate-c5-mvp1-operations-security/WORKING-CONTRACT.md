...
Контракт начала C5; таблица ниже сохраняет факты входа. Текущая стадия и итог находятся в HANDOFF.md и ACCEPTANCE.md. База `1b3cf67405c4523258dd8b400d17d09601f815ff`, tree
