...
Telegram/voice и CLI boundary пока не соединены с Core в один вертикальный сценарий. Постоянного хранилища, authenticated identity boundary, live CLI worker и production deployment нет.
