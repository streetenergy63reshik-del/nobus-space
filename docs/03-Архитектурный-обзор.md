...
8. его DTO/state/registry имеет одного владельца;
9. effect-bearing admission и outcome/outbox атомарны;
10. provider unknown отделён от delivery unknown;
11. local/provider identity остаётся opaque вне trusted adapter;
12. backend precondition не заявляется сильнее официального API.
...
- [`adr/0018-cross-gate-mvp1-integration.md`](adr/0018-cross-gate-mvp1-integration.md)
