...
но остаётся default-off / NOT DEPLOYED; C2 — локальный BLOCKED-кандидат: ASR qualification PASS; прежняя версия дала пять готовых ответов и UNKNOWNtext PASS, voice UNKNOWN не прошёл. Новый compiler prompt требует своей B02-проверки,
