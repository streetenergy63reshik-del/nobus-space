...
| C3 — стабильность Core/backend/worker | DRAFT / FINAL REVIEW | [приёмка](gate-c3-core-stability/ACCEPTANCE.md), [передача](gate-c3-core-stability/HANDOFF.md) |
