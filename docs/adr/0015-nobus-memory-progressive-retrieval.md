...
3. `.git`, `.obsidian`, Inbox, Sources, Archive и Templates не попадают в LLM
...
- Новая запись владельца сохраняется сразу, но не участвует в retrieval до курации и не меняет политики
