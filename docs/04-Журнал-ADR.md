...
| [0025](adr/0025-miniapp-session-and-request-recovery.md) | Core-owned session rotation и восстановление запроса Mini App без повторного admission | ACCEPTED FOR C4 IMPLEMENTATION | C4 DRAFT; NOT DEPLOYED |
| [0026](adr/0026-channel-neutral-product-projection.md) | Общие состояния, причины, действия и безопасное представление результата в Telegram и Mini App | ACCEPTED FOR C4 IMPLEMENTATION | C4 DRAFT; NOT DEPLOYED |
